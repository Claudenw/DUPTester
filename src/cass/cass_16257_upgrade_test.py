...
os.system("cp " + base_file + "16257 " + base_file)
...
os.system("cp " + mig_dir + "/generated_files/unitTest_cass_SimpleQueryTest_testTableWithTwoClustering_upgrade_test.py " + curr_dir+"/generated_test")
