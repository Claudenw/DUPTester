...
time.sleep(150)
os.system("docker exec container_cass_cassandra-2.1.0_stressTest_N1 /cassandra/tools/bin/cassandra-stress write n=1000 -node 252.11.1.2,252.11.1.3 > tmp 2>&1")
time.sleep(10)
