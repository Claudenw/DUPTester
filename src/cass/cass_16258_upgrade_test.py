...
docker_dir = curr_dir + "/../../systems/cass/saved_data/16258/"
docker_path = docker_dir + "docker-compose.yml"
target_dir = curr_dir + "/../../tests/cass/16258/"
...
time.sleep(150)
os.system("docker exec container_cass_cassandra-3.11.6_stressTest_N1 /cassandra/tools/bin/cassandra-stress user profile=/cassandra/tools/cqlstress-example.yaml ops\(insert =3\) no-warmup cl=QUORUM -node 252.11.1.2 > tmp 2>&1")
time.sleep(10)
