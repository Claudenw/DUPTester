...
saved_dir = curr_dir + "/../../systems/hbase/saved_data/24556"
dest_dir = curr_dir + "/../../tests/hbase/24556/"
...
time.sleep(10)
p = subprocess.Popen('docker exec ' + container_name + ' bash /hbase/bin/start-hbase.sh > ./reproduce_result/log 2>&1', shell=True)
p.wait()
time.sleep(150)
p = subprocess.Popen('docker exec ' + container_name + ' /hbase/bin/hbase pe --nomapred --oneCon=true --valueSize=10 --rows=100 equentialWrite 1 >> ./reproduce_result/log 2>&1', shell=True)
p.wait()
