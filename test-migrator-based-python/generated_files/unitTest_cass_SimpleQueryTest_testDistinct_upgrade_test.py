...
testId = 13
testName = 'SimpleQueryTest_testDistinct'

class casstestDistinctUpgradeTest(upgrade_test_base.UpgradeTestBase):
...
if (__name__ == '__main__'):
    ...
    test = casstestDistinctUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
