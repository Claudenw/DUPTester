...
testId = 5
testName = 'SimpleQueryTest_testTableWithOneClustering'

class casstestTableWithOneClusteringUpgradeTest(upgrade_test_base.UpgradeTestBase):
    ...
    def test_old_version(self):
        ...
        test.tester.setUpClass(num_nodes, subnet)
        test.tester.beforeTest()
        test.testTableWithOneClustering()
...
if (__name__ == '__main__'):
    ...
    test = casstestTableWithOneClusteringUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
