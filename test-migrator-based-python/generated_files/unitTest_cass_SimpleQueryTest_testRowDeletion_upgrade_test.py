...
testId = 9
testName = 'SimpleQueryTest_testRowDeletion'

class casstestRowDeletionUpgradeTest(upgrade_test_base.UpgradeTestBase):
...
if (__name__ == '__main__'):
    ...
    test = casstestRowDeletionUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
