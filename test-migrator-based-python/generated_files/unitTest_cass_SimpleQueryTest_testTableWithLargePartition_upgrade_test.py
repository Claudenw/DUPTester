...
testId = 8
testName = 'SimpleQueryTest_testTableWithLargePartition'

class casstestTableWithLargePartitionUpgradeTest(upgrade_test_base.UpgradeTestBase):
    ...
    def test_old_version(self):
        ...
        test.tester.setUpClass(num_nodes, subnet)
        test.tester.beforeTest()
        test.testTableWithLargePartition()
...
if (__name__ == '__main__'):
    ...
    test = casstestTableWithLargePartitionUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
