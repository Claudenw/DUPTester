...
testId = 14
testName = 'SimpleQueryTest_collectionDeletionTest'

class casscollectionDeletionTestUpgradeTest(upgrade_test_base.UpgradeTestBase):
...
if (__name__ == '__main__'):
    ...
    test = casscollectionDeletionTestUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
