...
testId = 15
testName = 'SimpleQueryTest_limitWithMultigetTest'

class casslimitWithMultigetTestUpgradeTest(upgrade_test_base.UpgradeTestBase):
...
if (__name__ == '__main__'):
    ...
    test = casslimitWithMultigetTestUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
