...
testId = 6
testName = 'SimpleQueryTest_testTableWithReverseClusteringOrder'

class casstestTableWithReverseClusteringOrderUpgradeTest(upgrade_test_base.UpgradeTestBase):
    ...
    def test_old_version(self):
        ...
        test.tester.setUpClass(num_nodes, subnet)
        test.tester.beforeTest()
        test.testTableWithReverseClusteringOrder()
...
if (__name__ == '__main__'):
    ...
    test = casstestTableWithReverseClusteringOrderUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
