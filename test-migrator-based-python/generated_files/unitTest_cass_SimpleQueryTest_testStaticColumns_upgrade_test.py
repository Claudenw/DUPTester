...
testId = 12
testName = 'SimpleQueryTest_testStaticColumns'

class casstestStaticColumnsUpgradeTest(upgrade_test_base.UpgradeTestBase):
...
if (__name__ == '__main__'):
    ...
    test = casstestStaticColumnsUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
