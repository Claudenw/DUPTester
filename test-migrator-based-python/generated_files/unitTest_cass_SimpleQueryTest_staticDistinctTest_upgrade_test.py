...
testId = 16
testName = 'SimpleQueryTest_staticDistinctTest'

class cassstaticDistinctTestUpgradeTest(upgrade_test_base.UpgradeTestBase):
...
if (__name__ == '__main__'):
    ...
    test = cassstaticDistinctTestUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
