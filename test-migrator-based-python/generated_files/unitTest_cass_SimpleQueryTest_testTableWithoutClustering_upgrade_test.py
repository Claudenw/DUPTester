...
testId = 4
testName = 'SimpleQueryTest_testTableWithoutClustering'

class casstestTableWithoutClusteringUpgradeTest(upgrade_test_base.UpgradeTestBase):
    ...
    def test_old_version(self):
        ...
        test.tester.setUpClass(num_nodes, subnet)
        test.tester.beforeTest()
        test.testTableWithoutClustering()
...
if (__name__ == '__main__'):
    ...
    test = casstestTableWithoutClusteringUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
