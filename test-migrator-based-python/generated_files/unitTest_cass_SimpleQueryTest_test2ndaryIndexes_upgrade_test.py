...
testId = 11
testName = 'SimpleQueryTest_test2ndaryIndexes'

class casstest2ndaryIndexesUpgradeTest(upgrade_test_base.UpgradeTestBase):
...
if (__name__ == '__main__'):
    ...
    test = casstest2ndaryIndexesUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
