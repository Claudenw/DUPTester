...
testId = 20
testName = 'SimpleQueryTest_testSStableTimestampOrdering'

class casstestSStableTimestampOrderingUpgradeTest(upgrade_test_base.UpgradeTestBase):
    ...
    def test_old_version(self):
        ...
        test.tester.setUpClass(num_nodes, subnet)
        test.tester.beforeTest()
        test.testSStableTimestampOrdering()
...
if (__name__ == '__main__'):
    ...
    test = casstestSStableTimestampOrderingUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
