...
testId = 19
testName = 'SimpleQueryTest_testRowFilteringOnStaticColumn'

class casstestRowFilteringOnStaticColumnUpgradeTest(upgrade_test_base.UpgradeTestBase):
    ...
    def test_old_version(self):
        ...
        test.tester.setUpClass(num_nodes, subnet)
        test.tester.beforeTest()
        test.testRowFilteringOnStaticColumn()
...
if (__name__ == '__main__'):
    ...
    test = casstestRowFilteringOnStaticColumnUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
