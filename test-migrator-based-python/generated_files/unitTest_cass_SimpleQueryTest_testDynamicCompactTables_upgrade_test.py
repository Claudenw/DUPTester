...
testId = 3
testName = 'SimpleQueryTest_testDynamicCompactTables'

class casstestDynamicCompactTablesUpgradeTest(upgrade_test_base.UpgradeTestBase):
...
if (__name__ == '__main__'):
    ...
    test = casstestDynamicCompactTablesUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
