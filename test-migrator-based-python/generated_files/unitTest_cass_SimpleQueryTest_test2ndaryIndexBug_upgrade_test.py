...
testId = 17
testName = 'SimpleQueryTest_test2ndaryIndexBug'

class casstest2ndaryIndexBugUpgradeTest(upgrade_test_base.UpgradeTestBase):
...
if (__name__ == '__main__'):
    ...
    test = casstest2ndaryIndexBugUpgradeTest(upgrade_edge, config, application_start_interval, 'unittest', testName, str(testId))
    test.test_upgrade()
