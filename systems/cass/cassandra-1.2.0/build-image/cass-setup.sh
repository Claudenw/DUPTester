tar zxf /apache-cassandra-1.2.0-bin.tar.gz
mv /apache-cassandra-1.2.0 /cassandra
...
sed -i 's/org.apache.cassandra.dht.Murmur3Partitioner/org.apache.cassandra.dht.RandomPartitioner/' /cassandra/conf/cassandra.yaml
